...
# airflow_on_k8s documentation build
...
from airflow_on_k8s import __version__ as release


# -- Project information -----------------------------------------------------

project = "airflow_on_k8s"
author = "Kedro"
...
htmlhelp_basename = "airflow_on_k8sdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "airflow_on_k8s",
        "Project airflow_on_k8s codebase.",
        "Data-Science",
    )
]
